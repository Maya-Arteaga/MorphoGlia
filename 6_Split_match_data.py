        ...
        for tr in treatment:
            for ti in tissue:
                ...
                if combination_exists:
                    ...
                    output_file = f"{s}_{g}_{tr}_{ti}_Morphology_UMAP_HDBSCAN_{n_neighbors}_{min_dist}_{min_cluster_size}_{min_samples}.csv"
...
for s in subject:
    for g in group:
        for tr in treatment:
            for ti in tissue:
                csv_file_name = f"{s}_{g}_{tr}_{ti}_Morphology_UMAP_HDBSCAN_{n_neighbors}_{min_dist}_{min_cluster_size}_{min_samples}.csv"
