...
plt.title('UMAP Analysis by Group: SS CA1', fontsize=18)
plt.xlabel('UMAP 1', fontsize=14)
plt.ylabel('UMAP 2', fontsize=14)
plt.legend()
plt.grid(False)

plt.savefig(UMAP_path + f"UMAP_{n_neighbors}_{min_dist}_Categories_SS_CA1.png", dpi=800)
plt.show()
...
plt.title('UMAP Analysis by Group: SCOP CA1', fontsize=18)
plt.xlabel('UMAP 1', fontsize=14)
plt.ylabel('UMAP 2', fontsize=14)
plt.legend()
plt.grid(False)

plt.savefig(UMAP_path + f"UMAP_{n_neighbors}_{min_dist}_Categories_SCOP_CA1.png", dpi=800)
plt.show()
...
plt.title('UMAP Analysis by Group: SS Hilus', fontsize=18)
plt.xlabel('UMAP 1', fontsize=14)
plt.ylabel('UMAP 2', fontsize=14)
plt.legend()
plt.grid(False)

plt.savefig(UMAP_path + f"UMAP_{n_neighbors}_{min_dist}_Categories_SS_Hilus.png", dpi=800)
plt.show()
...
plt.title('UMAP Analysis by Group: SCOP Hilus', fontsize=18)
plt.xlabel('UMAP 1', fontsize=14)
plt.ylabel('UMAP 2', fontsize=14)
plt.legend()
plt.grid(False)

plt.savefig(UMAP_path + f"UMAP_{n_neighbors}_{min_dist}_Categories_SCOP_Hilus.png", dpi=800)
plt.show()
