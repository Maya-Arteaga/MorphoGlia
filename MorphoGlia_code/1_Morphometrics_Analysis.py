        ...
        for tr in treatment:
            for ti in tissue:
                 ...
                 if os.path.isfile(image_path):
                    ...
                    individual_img_path= mg.set_path(o_path+f"{s}_{g}_{tr}_{ti}_CA1_FOTO1_PROCESSED/")
...
#########################################  CELL FEATURES ANALYSIS #############################################
                    ...
                    df_cell = pd.DataFrame(columns=["Cell", "Cell_area", "Cell_perimeter", "Cell_circularity", "Cell_compactness", "Cell_orientation", "Cell_feret_diameter", "Cell_eccentricity", "Cell_aspect_ratio"])
...
################################################# SOMA ANALYSIS #################################################
                    ...
                    df_area = pd.DataFrame(columns=["Cell", "Soma_area", "Soma_perimeter", "Soma_circularity", "Soma_compactness", "Soma_orientation", "Soma_feret_diameter", "Soma_eccentricity", "Soma_aspect_ratio"]) 
                    ...
                    for soma in os.listdir(Soma_path):
                        if soma.endswith(".tif"):
                            ...
                            # Append the results to the DataFrame
                            df_area = df_area.append(pd.DataFrame({
                                "Cell": [soma],
                                "Soma_area": [Soma_area],
                           ...
                           #df_area = df_area.append({"Cell": soma, "Soma_area": Soma_area, "Soma_perimeter": Soma_perimeter, "Soma_circularity": Soma_circularity, "Soma_compactness": Soma_compactness, "Soma_orientation": Soma_orientation, "Soma_feret_diameter": Soma_feret_diameter, "Soma_eccentricity": Soma_eccentricity, "Soma_aspect_ratio": Soma_aspect_ratio}, ignore_index=True)
...
######################################## CONVEX HULL: FRACTAL ANALYSIS ########################################
                    ...
                    df_Convex_Hull = pd.DataFrame(columns=["Cell", "Convex_Hull_area", "Convex_Hull_perimeter", "Convex_Hull_compactness"])
