...
Heatmap_path <- file.path("Output_images", "Plots", "Heatmap_R_2")
...
ht <- Heatmap(heatmap_data, 
              ...
              col = colorRampPalette(RColorBrewer::brewer.pal(10, "RdBu"))(50), # Apply color palette
...
# Draw the heatmap
png(filename = file.path(Heatmap_path, "heatmap_with_dendrogram_Categories.png"), width = 1200, height = 1400)
