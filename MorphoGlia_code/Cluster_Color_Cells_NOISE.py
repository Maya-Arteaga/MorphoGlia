...
ID_path= set_path(o_path+f"ID_clusters_UMAP_{n_neighbors}_NOISE/")
    ...
    for g in group:
        for tr in treatment:
            for ti in tissue:
                ...
                csv_file = f"{s}_{g}_{tr}_{ti}_Morphology_UMAP_HDBSCAN_{n_neighbors}_{min_dist}_{min_cluster_size}_{min_samples}.csv"
                                    ...
                                    if image_filename in os.listdir(Cells_thresh_path):
                                        ...
                                        if os.path.isfile(input_image):
                                            ...
                                            cluster_colors = {
                                               ...
                                               #-1: (87, 139, 46),
                                               0: (255, 255, 255),      #Red
                                               1: (255, 255, 255),    #Orange
                                               3: (255, 255, 255),    # green
                                               4: (255, 255, 255),  #palecyan
                                               5: (255, 255, 255),     # cyan
                                               #: (255, 255, 255),
                                               #6: (87, 139, 46),
                                               2: (255, 255, 255)    #yellow
