...
cluster_colors = {
    "VEH_SS": "limegreen",
    "VEH_SCO": "crimson",
    "CNEURO-01_SCO": "darkorange",
    "CNEURO-10_SCO": "yellow",
    "CNEURO-10_SS": "mediumturquoise"
...
cluster_colors = {
    "VEH_SS": "limegreen",
    "VEH_SCO": "gainsboro",
    "CNEURO-01_SCO": "gainsboro",
    "CNEURO-10_SCO": "gainsboro",
    "CNEURO-10_SS": "gainsboro"
...
plt.savefig(UMAP_path + f"UMAP_{n_neighbors}_{min_dist}_Categories_CNEURO1_SS.png", dpi=800)
plt.show()
